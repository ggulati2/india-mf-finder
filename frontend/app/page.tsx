  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-6 md:py-10 flex items-center justify-between gap-4 sm:gap-6 flex-wrap">
          <div className="flex items-center gap-3 sm:gap-4 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-lg sm:text-2xl md:text-3xl font-bold text-slate-900 dark:text-white tracking-tight leading-tight truncate">India Mutual Fund Finder</h1>
      ...
      <div className="bg-amber-50 dark:bg-amber-950/30 border-b border-amber-200 dark:border-amber-900/50">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-2.5 flex items-start gap-2 text-sm text-amber-800 dark:text-amber-300">
      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <section className="card p-5">
          <div className="flex items-center gap-2 mb-4 flex-wrap">
            ...
            <label className="flex items-center gap-1.5 text-xs text-slate-600 dark:text-slate-300 w-full sm:w-auto" title="Hide funds where any data check is missing (for example expense ratio). Click Find Funds again to apply."><input type="checkbox" checked={completeOnly} onChange={(e)=>setCompleteOnly(e.target.checked)} />Only complete data</label>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            <div className="flex items-center justify-between mb-4 gap-2 flex-wrap">
              ...
              <span className="text-xs sm:text-sm text-slate-500">Click to select for comparison • Sorted by {sortBy}</span>
            </div>
